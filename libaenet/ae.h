...
typedef struct __tag_Event_Loop AE_EVENT_LOOP;
typedef struct __tag_AeTimeEvent AE_TIME_EVENT;

typedef void AeFileProc(AE_EVENT_LOOP * event_loop, int fd, void *client_data, int mask);
typedef int AeTimeProc(AE_EVENT_LOOP * event_loop, long long id, void *client_data);
typedef void AeEventFinalizerProc(AE_EVENT_LOOP * event_loop, void *client_data);
typedef void AeBeforeSleepProc(AE_EVENT_LOOP * event_loop);
